    ...
    <section class="gallery-page-section">
        <div class="auto-container">
            <div class="row clearfix" id="gallery-items">
                @include('frontend.gallery.partials.tobas-gallery-items', ['topasGallery' => $tobaGallery['topasGallery']])
            </div>
            <div class="text-center">
                @if ($tobaGallery['topasGallery']->hasMorePages())
...
@push('scripts')
    <script>
        $(document).on('click', '#load-more', function () {
            ...
            $.ajax({
                url: '{{ route("frontend.tobas.gallery" , $tobaGallery['id']) }}',
                type: 'GET',
                data: {page: page},
