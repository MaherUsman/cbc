...
@section('content')
    <style>
        ...
        .iti {
            width: 100%;
            /* Ensures the phone input takes up full width */
        ...
        .iti__flag-container {
            margin-right: 8px;
            /* Adjust space between flag and phone number */
            vertical-align: middle;
            /* Align flag icon with input text */
        }

        /* Phone input to ensure text does not overlap with the dropdown */
        .iti input {
            padding-left: 58px;
            /* Create enough space for the flag and dropdown */
        }

        /* Adjust dropdown arrow positioning */
        .iti__selected-flag {
            width: 48px;
            /* Space for the flag and dropdown icon */
        }

        /* Optional: Make the dropdown arrow more prominent */
        .iti__arrow {
            margin-left: 4px;
            /* Slight adjustment to the arrow */
            vertical-align: middle;
            /* Ensures it stays aligned with the flag */
        }
    ...
    <section class="google-map-section">
        <div class="auto-container">
            <div class="map-inner">
                ...
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1574.4138450616574!2d72.041171!3d29.2950139!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x393b8b464ba8f583%3A0xee4fbde50e2c9475!2sSHEIKH%20MOHAMMAD%20BIN%20ZAYED%20AL%20NAHYAN%20CONSERVATION%20BREEDING%20CENTRE!5e1!3m2!1sen!2s!4v1731305585633!5m2!1sen!2s"
            ...
            <div class="row clearfix">
                <div class="col-xl-8 col-lg-12 offset-xl-2 big-column">
                    <div class="sec-title centred">
                        <h2>If You Have a Question? <br />Drop a line Please</h2>
                    </div>
                    ...
                    <div class="form-inner">
                        <form method="post" action="{{ route('frontend.contact.submit') }}" id="contact-form"
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 form-group">
                                    <input type="text" id="phone" name="phone" value="{{ old('phone') }}" required
                                        style="padding: 10px 10px 10px 45px">
                                    @error('phone')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
