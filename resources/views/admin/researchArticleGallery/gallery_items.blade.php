<!-- resources/views/admin/blogGallery/gallery_items.blade.php -->
@foreach($researchArticleGalleries as $gallery)
            ...
            <div class="gallery-overlay rounded">
                <div class="overlay-icons-wrapper w-100 d-flex flex-column align-items-end">
                    <div class="overlay-icon mt-2">
                        <a href="{{ route('researchArticleGalleries.edit', $gallery) }}">
...
{{--                    </div>--}}
                    <div class="overlay-icon mt-2">
                        <a href="#" data-url="{{ route('researchArticleGalleries.destroy', $gallery) }}" title="Delete"
