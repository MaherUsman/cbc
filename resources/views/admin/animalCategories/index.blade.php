...
@section('content')
    ...
    @include('layouts.admin.includes.breadcrumbs' , ['breadcrumbs' => [['name' => __('animalCategories.name') , 'route' => null]],
'pageTitle' => __('animalCategories.pageTitle')
])
                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('animalCategories.list_animalCategories') }}</h4>
                            <a href="{{ route('animal-categories.create') }}"
                               class="btn btn-primary">{{ __('animalCategories.add_animalCategories') }}</a>
                        </div>
                        <div class="card-body">
