                                    ...
                                    <select class="form-control" name="category_id" data-rule-required="true"
                                        ...
                                        @foreach($animalCategories as $category)
                                            <option value="{{$category->id}}"
                                                    @if($animal->category_id == $category->id) selected @endif>{{$category->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label">{{__('animals.admin.create.home_image')}}<span
                                            class="text-danger">*</span></label>
                                    <input type="file" id="homeImageUpload" name="home_image"
                                           class="form-control imageUpload"
                                           accept="image/*"
                                           data-msg-required="{{__('animals.admin.create.home_image_message')}}">
                                </div>
                                <div class="mb-3">
                                    <img src="{{asset($animal->home_image?:'no_image.jpg')}}" id="homeImagePreview"
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label">{{__('animals.admin.create.banner_image')}}<span
                                            class="text-danger">*</span></label>
                                    <input type="file" name="banner_image" id="bannerImageUpload"
                                           class="form-control imageUpload"
                                           accept="image/*"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="show_on_top_bar">
                                        ...
                                        <option value="1" {{ $animal->show_on_top_bar == 1 ? 'selected' : '' }}>Yes
                                        </option>
                                        <option value="0" {{ $animal->show_on_top_bar == 0 ? 'selected' : '' }}>No
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="form-label">{{__('animals.admin.create.is_amazing')}}<span
                                            class="text-danger">*</span></label>
                                    <select class="form-control" id="is_amazing" name="is_amazing"
                                            data-rule-required="true"
                                            data-msg-required="{{__('animals.admin.create.is_amazing_message')}}">
                                        <option value="">Select</option>
                                        <option value="yes" {{ $animal->is_amazing == 'yes' ? 'selected' : '' }}>Yes
                                        </option>
                                        <option value="no" {{ $animal->is_amazing == 'no' ? 'selected' : '' }}>No
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6" id="displayOrderContainer"
                                ...
                                <div class="form-group">
                                    <label class="form-label">{{__('animals.admin.create.display_order')}}<span
                                            class="text-danger">*</span></label>
                                    <input type="number" data-rule-required="true"
                                           data-msg-required="{{__('animals.admin.create.display_order_message')}}"
                                           name="display_order" id="display_order" value="{{$animal->display_order}}"
                                           class="form-control"
                                ...
                                <div class="col-sm-3 image-container">
                                    <div class="mb-3 position-relative preview-img-wrapper">
                                        <a href="{{ asset($animalslider->image ?: 'no_image.jpg') }}" target="_blank">
                                            <img id="imagePreview"
                                                 src="{{ asset($animalslider->image ?: 'no_image.jpg') }}"
                                                 alt="Image Preview" class="img-thumbnail"
                                                 style="{{ $animalslider->image ? '' : 'display:none;' }} max-width:200px;"></a>
                                        <button type="button"
                                                class="btn btn-danger btn-sm position-absolute img-del-btn delete-image deleteRecord"
                                                data-id="{{ $animalslider->id }}"
                                                data-url="{{ route('delete.animal.slider.image', $animalslider->id) }}"
                                                style="margin: 5px;">
                    ...
                    try {
                        ...
                        if (currentChunk === totalChunks) {
                            return {
                                ...
                                compressedPath: response.compressedPath,
