                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('topasChildGallery.list_topasChildGallery') }}</h4>
                            <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">{{ __('topasChildGallery.add_topasChildGallery') }}</button>
    ...
    <div class="modal fade bd-example-modal-lg" id="basicModal">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form method="POST" id="formValidation" action="{{route('topas-child-galleries.store')}}"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">{{__('topasChildGallery.admin.create.create')}}</h5>
