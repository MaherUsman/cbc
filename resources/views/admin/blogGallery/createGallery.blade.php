...
@section('content')
    @include('layouts.admin.includes.breadcrumbs', [
        'breadcrumbs' => [['name' => __('blogGalleries.admin.breadcrumbs.name'), 'route' =>null ],
        ['name' => __('blogGalleries.admin.breadcrumbs.create'), 'route' =>null ]],
        'pageTitle' => __('blogGalleries.admin.breadcrumbs.create')
    ])
    ...
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{__('blogGalleries.admin.create.create')}}</h6>
                    <form method="POST" id="formValidation" action="{{route('blog-galleries.store',$blog)}}"
                        ...
                        <a href="{{route('blog-galleries.index',$blog)}}" class="btn btn-danger light btn-sl-sm"
                           type="button">
        ...
        $(document).ready(function () {
            ...
            async function submitFormData(url, data) {
                ...
                try {
                    ...
                    setTimeout(function () {
                        window.location.href = "{{route('blog-galleries.index',$blog)}}";
                    }, 1000);
                } catch (xhr) {
                    $.unblockUI();
