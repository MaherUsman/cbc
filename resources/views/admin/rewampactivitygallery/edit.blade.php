...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Activity Gallery Edit</h6>
                    <form method="POST" id="formValidation" action="{{route('rewap_activity_gallery.update',$tobaGallery)}}"
                        ...
                        <div class="row rowTemplate">
                            <div class="col-sm-3">
                                <div class="mb-3">
                                    <label class="form-label">Activity Gallery<span
