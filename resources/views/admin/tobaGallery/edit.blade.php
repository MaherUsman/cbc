...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{__('tobaGallery.admin.edit.edit')}}</h6>
                    <form method="POST" id="formValidation" action="{{route('toba-galleries.update',$tobaGallery)}}"
                        ...
                        <div class="row rowTemplate">
                            <div class="col-sm-3">
                                <div class="mb-3">
                                    <label class="form-label">{{__('tobaGallery.admin.edit.title')}}<span
                                            class="text-danger">*</span> </label>
                                    <input type="text" data-rule-required="true"
                                           data-msg-required="{{__('tobaGallery.admin.edit.title_message')}}"
                                           name="title" class="form-control" value="{{$tobaGallery->title}}"
                                           placeholder="{{__('tobaGallery.admin.edit.title')}}">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="mb-3">
                                    ...
                                    <select name="show_on_navbar" id="show_on_navbar" class="form-control"
                                            data-rule-required="true"
                                            data-msg-required="{{ __('tobaGallery.admin.edit.show_on_navbar_message') }}">
                                        <option
                                            value="1" {{$tobaGallery->show_on_navbar==1?'selected':''}}>{{ __('Yes') }}</option>
                                        <option
                                            value="0" {{$tobaGallery->show_on_navbar==0?'selected':''}}>{{ __('No') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="mb-3">
                                    <label class="form-label">{{__('tobaGallery.admin.edit.image')}}<span
                                    ...
                                    <input type="file" id="imageUpload" name="image" class="form-control"
                                           ...
                                           data-msg-required="{{__('tobaGallery.admin.edit.image_message')}}">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="mb-3">
                                    <img src="{{asset($tobaGallery->image)}}" alt="Image Preview" class="img-thumbnail"
