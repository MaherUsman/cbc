...
@section('content')
    @include('layouts.admin.includes.breadcrumbs', [
        ...
        ['name' => __('jobs.admin.breadcrumbs.create'), 'route' => 'jobs.create']],
        'pageTitle' => __('jobs.admin.breadcrumbs.create')
    ])
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    {{--                    <h6 class="card-title">{{__('jobs.admin.create.create')}}</h6>--}}
                    <form method="POST" id="formValidation" action="{{route('jobs.store')}}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label">{{__('jobs.admin.create.title')}}<span
                                            class="text-danger">*</span> </label>
                                    <input type="text" data-rule-required="true"
                                           data-msg-required="{{__('jobs.admin.create.title_message')}}"
                                           name="title" value="{{old('title')}}" class="form-control"
                                           placeholder="{{__('jobs.admin.create.title')}}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    >{{__('jobs.admin.create.details')}}<span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label">{{__('jobs.admin.create.closing_date')}}<span
                                            class="text-danger">*</span> </label>
                                    <input type="text" data-rule-required="true" id="closing_date"
                                           data-msg-required="{{__('jobs.admin.create.closing_date_message')}}"
                                           name="closing_date" value="{{old('closing_date')}}" class="form-control"
                                           placeholder="{{__('jobs.admin.create.closing_date')}}">
                                </div>
                            </div>
                        </div>
