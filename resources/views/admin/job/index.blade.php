...
@section('content')
    ...
    @include('layouts.admin.includes.breadcrumbs' , ['breadcrumbs' => [['name' =>  __('jobs.name') , 'route' => null]],
'pageTitle' => __('jobs.pageTitle')
])
                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('jobs.list_jobs') }}</h4>
                            <a href="{{ route('jobs.create') }}"
                               class="btn btn-primary">{{ __('jobs.add_job') }}</a>
                        </div>
                        <div class="card-body">
