...
@section('content')
    @include('layouts.admin.includes.breadcrumbs', [
        'breadcrumbs' => [['name' => __('securityGalleries.admin.breadcrumbs.name'), 'route' =>null ],
        ['name' => __('securityGalleries.admin.breadcrumbs.create'), 'route' =>null ]],
        'pageTitle' => __('securityGalleries.admin.breadcrumbs.create')
    ])
    ...
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{__('securityGalleries.admin.create.create')}}</h6>
                    <form method="POST" id="formValidation" action="{{route('securityGalleries.store',$security)}}"
                        ...
                        <a href="{{route('securityGalleries.index',$security)}}" class="btn btn-danger light btn-sl-sm"
                           type="button">
