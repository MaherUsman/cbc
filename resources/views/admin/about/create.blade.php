...
@section('content')
    @include('layouts.admin.includes.breadcrumbs', [
        ...
        ['name' => __('abouts.admin.breadcrumbs.create'), 'route' => 'abouts.create']],
        'pageTitle' => __('abouts.admin.breadcrumbs.create')
    ])
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{__('abouts.admin.create.create')}}</h6>
                    <form method="POST" id="formValidation" action="{{route('abouts.store')}}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label">{{__('abouts.admin.create.title')}}<span
                                            class="text-danger">*</span> </label>
                                    <input type="text" data-rule-required="true"
                                           data-msg-required="{{__('abouts.admin.create.title_message')}}"
                                           name="title" value="{{old('title')}}" class="form-control"
                                           placeholder="{{__('abouts.admin.create.title')}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label">{{__('abouts.admin.create.slink')}}<span
                                            class="text-danger">*</span> </label>
                                    <input type="text" data-rule-required="true"
                                           data-msg-required="{{__('abouts.admin.create.slink_message')}}"
                                           name="slink" value="{{old('slink')}}" class="form-control"
                                           placeholder="{{__('abouts.admin.create.slink')}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    >{{__('abouts.admin.create.details')}}</label>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label">{{__('abouts.admin.create.image')}}<span
                                            class="text-danger">(270 x 400)*</span></label>
                                    <input type="file" name="image" class="form-control" id="imageUpload"
                                           accept="image/*" data-rule-required="true"
                                           data-msg-required="{{__('abouts.admin.create.image_message')}}">
                                </div>
                                <div class="mb-3">
