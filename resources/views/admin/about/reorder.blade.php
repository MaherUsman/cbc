...
@section('content')
    ...
    @include('layouts.admin.includes.breadcrumbs' , ['breadcrumbs' => [['name' =>  __('abouts.name') , 'route' => null]],
'pageTitle' => __('abouts.reOrder')
])

    <div class="row">
        <div class="col-lg-12">
            <ul class="nav nav-pills mb-3">
                <li class="nav-item"><a href="{{route('abouts.index')}}#list-view" {{--data-bs-toggle="tab"--}}
                                        class="nav-link">{{ __('common.list_view') }}</a></li>
                <li class="nav-item"><a href="{{route('abouts.gridView')}}#grid-view" data-bs-toggle="tab"
            ...
            <div class="row tab-content">
                <div id="grid-view" class="tab-pane fade active show col-lg-12">
                    <div class="row" id="sortable">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" id="{{$about->id}}">
                            <div class="card card-img">
                                <img src="{{asset($about->image?:'no_image.jpg')}}" class="card-img-top img-fluid" alt="...">
                                <div class="card-img-icon">
                                    <a title="Edit" href="{{route('abouts.edit',$about)}}">
                                    ...
                                    <a data-url="{{ route('abouts.destroy', $about) }}"
                            ...
                            {{--<div class="card card-profile" style="background-image: {{asset($about->image)}}">
                                ...
                                <div class="card-body pt-2">
                                    <div class="text-center">
                                        <div class="profile-photo">
                                            <img src="{{asset($about->image)}}" width="100" class="img-fluid rounded-circle" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>--}}
