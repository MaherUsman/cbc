...
@section('content')
    @include('layouts.admin.includes.breadcrumbs', [
        ...
        ['name' => __('blogs.admin.breadcrumbs.edit'), 'route' => null]],
        'pageTitle' => __('blogs.admin.breadcrumbs.edit')
    ])
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
{{--                    <h6 class="card-title">{{__('blogs.admin.edit.edit')}}</h6>--}}
                    <form method="POST" id="formValidation" action="{{route('blogs.update',['blog'=>$blog])}}"
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label">{{__('blogs.admin.edit.title')}}<span
                                            class="text-danger">*</span> </label>
                                    <input type="text" data-rule-required="true"
                                           data-msg-required="{{__('blogs.admin.edit.title_message')}}"
                                           name="title" value="{{$blog->title}}" class="form-control"
                                           placeholder="{{__('blogs.admin.edit.title')}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-3">
...
>>>>>>> bbe6664a89fd5a951a405ebf50a0b3dfec47d30f
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="form-label" for="datepicker">{{__('blogs.admin.edit.start_date')}}{{--<span
                                            class="text-danger">*</span>--}}</label>
                                    <div class="input-hasicon mb-xl-0 mb-3">
                                        <input name="start_date"
                                               class="datepicker-default form-control"
                                               data-rule-required="false"
                                               data-msg-required="{{__('blogs.admin.edit.start_date_message')}}"
                                               id="datepicker" value="{{$blog->start_date}}"
                                               placeholder="{{__('blogs.admin.edit.start_date')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="form-label"
                                    >{{__('blogs.admin.edit.address')}}<span class="text-danger">*</span></label>
                                    <textarea name="address" class="form-control" data-rule-required="true"
                                              data-msg-required="{{__('blogs.admin.edit.address_message')}}">{{$blog->address}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3">
                                    <img id="imagePreview" src="{{asset($blog->image?:'no_image.jpg')}}"
                                         alt="Image Preview" class="img-thumbnail"
                                         style="{{$blog->image?'':'display:none;'}} max-width:200px; height:auto;">
                                </div>
                            </div><!-- Col -->
                            <div class="col-sm-6">
                                <div class="mb-3">
