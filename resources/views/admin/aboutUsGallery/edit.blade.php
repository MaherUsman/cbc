        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" id="formValidation" action="{{route('about-us-galleries.update',['aboutUsGallery'=>$aboutUsGallery])}}"
                        ...
                        <div class="row rowTemplate">
                            <div class="col-sm-5">
                                <div class="mb-3">
                                    ...
                                    <input type="text" data-rule-required="true"
                                           ...
                                           name="title" class="form-control" value="{{$aboutUsGallery->title}}"
                            ...
                            <div class="col-sm-3">
                                <div class="mb-3">
                                    <img src="{{asset($aboutUsGallery->image)}}" alt="Image Preview" class="img-thumbnail"
