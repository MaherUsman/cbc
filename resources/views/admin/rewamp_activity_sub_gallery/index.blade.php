    ...
    <div class="row">
        <div class="col-lg-12">
            <ul class="nav nav-pills mb-3">
                {{--<li class="nav-item"><a href="{{route('topas-child-galleries.index')}}#list-view" data-bs-toggle="tab"
                                        class="nav-link me-1 show active">{{ __('topasChildGallery.list_view') }}</a></li>--}}
                {{--<li class="nav-item"><a href="{{route('topas-child-galleries.gridView')}}#grid-view" --}}{{--data-bs-toggle="tab"--}}{{--
                    class="nav-link">{{ __('topasChildGallery.grid_view') }}</a></li>--}}
            </ul>
        </div>
        <div class="col-lg-12">
                ...
                <div id="list-view" class="tab-pane fade active show col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Activity Sub Gallery List</h4>
                            <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">Add Activity Sub Gallery</button>
                            {{--                            <a href="{{ route('topas-child-galleries.create') }}"--}}
                            {{--                               class="btn btn-primary">{{ __('topasChildGallery.add_topasChildGallery') }}</a>--}}
                        </div>
                                        ...
                                        <div class="gallery-img-wrapper position-relative w-100 h-100">
                                            ...
                                            <div class="gallery-overlay rounded">
                                                <div class="overlay-icons-wrapper w-100 d-flex flex-column align-items-end">
                                                    ...
                                                    <div class="overlay-icon mt-2">
                                                        <a href="#" data-url="{{ route('rewap_activity_sub_gallery.destroy', $gallery) }}" title="Delete"
    ...
    <div class="modal fade bd-example-modal-lg" id="basicModal">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form method="POST" id="formValidation" action="{{route('rewap_activity_sub_gallery.store')}}"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">Activity Sub Gallery</h5>
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" data-rule-required="true"
                                           data-msg-required="{{__('topasChildGallery.admin.create.title_message')}}"
                                           name="title[]" class="form-control"
                                           placeholder="{{__('topasChildGallery.admin.create.title')}}">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    <label class="form-label">{{__('topasChildGallery.admin.create.image')}}<span
                                            class="text-danger">*</span></label>
                                    <input type="file" name="image[]" class="form-control" accept="image/*"
                                           data-rule-required="true" onchange="previewImage(this)"
                                           data-msg-required="{{__('topasChildGallery.admin.create.image_message')}}">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary submit">{{__('topasChildGallery.admin.create.submit')}}</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            $('#formValidation').validate({
                submitHandler: async function (form, event) {
                    ...
                    data.append('topas_gallery_id', $('input[name="topas_gallery_id"]').val());
