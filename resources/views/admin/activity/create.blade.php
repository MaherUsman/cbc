                ...
                <div class="card-body">
                    ...
                    <form method="POST" id="formValidation" action="{{route('rewap_activity.store')}}"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    <label class="form-label">{{__('toba.admin.create.title')}}<span
                                            class="text-danger">*</span> </label>
                                    <input type="text" data-rule-required="true"
                                           data-msg-required="{{__('toba.admin.create.title_message')}}"
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="image" class="form-control" id="imageUpload"
                                           ...
                                           data-msg-required="{{__('toba.admin.create.image_message')}}">
                                </div>
                                <div class="mb-3">
