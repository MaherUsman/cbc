...
@section('content')
    @include('layouts.admin.includes.breadcrumbs', [
        ...
        ['name' => __('intros.admin.breadcrumbs.edit'), 'route' => null]],
        'pageTitle' => __('intros.admin.breadcrumbs.edit')
    ])
    <div class="row">
                    ...
                    <form method="POST" id="formValidation" action="{{route('intros.update',['intro'=>$intro])}}"
                        ...
                        @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            <label class="form-label">{{__('intros.admin.edit.title')}}<span
                                                    class="text-danger">*</span> </label>
                                            <input type="text" data-rule-required="true"
                                                   data-msg-required="{{__('intros.admin.edit.title_message')}}"
                                                   name="title" value="{{$intro->title}}" class="form-control"
                                                   placeholder="{{__('intros.admin.edit.title')}}">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            <label class="form-label">{{__('intros.admin.edit.image')}}</label>
                                            <input type="file" name="image" class="form-control" id="imageUpload"
                                                   accept="image/*">
                                        </div>
                                        <div class="mb-3">
                                            <img id="imagePreview" src="{{asset($intro->image?:'no_image.jpg')}}"
                                                 alt="Image Preview" class="img-thumbnail"
                                                 style="{{$intro->image?'':'display:none;'}} max-width:200px; height:auto;">
                                        </div>
                                    </div>
                                </div>
