...
@section('content')
    @include('layouts.admin.includes.breadcrumbs', [
        'breadcrumbs' => [['name' => 'Students', 'route' => 'students.index'], ['name' => 'Edit', 'route' => null]],
        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" id="formValidation" action="{{ route('students.update', $student) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        @include('admin.students._form')
                        <a href="{{ route('students.index') }}" class="btn btn-danger light btn-sl-sm">Cancel</a>
        ...
        $(document).ready(function () {
            ...
            async function submitFormData(url, data) {
                ...
                try {
                    ...
                    $.unblockUI();
                    successMsg(response.message || 'Updated Successfully');
                    setTimeout(function () {
