...
@section('content')
    @include('layouts.admin.includes.breadcrumbs', [
        'breadcrumbs' => [['name' => __('tobas.admin.breadcrumbs.name'), 'route' => 'tobas.index'],
        ['name' => __('tobas.admin.breadcrumbs.create'), 'route' => 'tobas.create']],
        'pageTitle' => __('tobas.admin.breadcrumbs.create')
    ])
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
{{--                    <h6 class="card-title">{{__('tobas.admin.create.create')}}</h6>--}}
                    <form method="POST" id="formValidation" action="{{route('tobas.store')}}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="row {{--bg-blue-light pt-2 rounded--}}">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label">{{__('tobas.admin.create.title')}}<span
                                            class="text-danger">*</span> </label>
                                    <input type="text" data-rule-required="true"
                                           data-msg-required="{{__('tobas.admin.create.title_message')}}"
                                           name="title" value="{{old('title')}}" class="form-control"
                                           placeholder="{{__('tobas.admin.create.title')}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label">{{__('tobas.admin.create.slug')}}</label>
                                    <input type="text" data-rule-required="false"
                                           data-msg-required="{{__('tobas.admin.create.slug_message')}}"
                                           name="slug" value="{{old('slug')}}" class="form-control"
                                           placeholder="{{__('tobas.admin.create.slug')}}">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="form-label">{{__('tobas.admin.create.details')}}<span
                                            class="text-danger">*</span></label>
                                    <textarea name="details" id="ckeditor" data-rule-required="true"
                                              data-msg-required="{{__('tobas.admin.create.details_message')}}"></textarea>
                                </div>
                            </div>
{{--                            <div class="col-sm-6">--}}
{{--                                <div class="mb-3">--}}
{{--                                    <label class="form-label">{{__('tobas.admin.create.image')}}<span--}}
...
{{--                                           data-msg-required="{{__('tobas.admin.create.image_message')}}">--}}
{{--                                </div>--}}
{{--                                <div class="mb-3">--}}
...
{{--                            </div>--}}
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label">{{__('tobas.admin.create.image')}}<span
                                            class="text-danger">*(252 x 452ssssssss)</span></label>
                                    <input type="file" id="homeImageUpload" name="image" class="form-control imageUpload"
                                           accept="image/*" data-rule-required="true"
                                           data-msg-required="{{__('tobas.admin.create.image_message')}}">
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="form-label">{{__('tobas.admin.create.show_on_navbar')}}<span
                                            class="text-danger">*</span></label>
                                    <select class="form-control" name="show_on_navbar" data-rule-required="false"
                                            data-msg-required="{{__('tobas.admin.create.is_amazing_message')}}">
                            ...
                            <div class="col-sm-6" id="displayOrderContainer" style="display:none;">
                                <div class="form-group">
                                    <label class="form-label">{{__('tobas.admin.create.display_order')}}<span
                                            class="text-danger">*</span></label>
                                    <input type="number" data-rule-required="true" data-msg-required="{{__('tobas.admin.create.display_order_message')}}"
                                           name="display_order" id="display_order" value="{{old('display_order')}}" class="form-control"
                                           placeholder="{{__('tobas.admin.create.display_order')}}">
                                </div>
                            </div>
                        </div>
                        <a href="{{route('tobas.index')}}" class="btn btn-danger light btn-sl-sm" type="button">
                            {{__('tobas.admin.form.cancel')}}
                        </a>
                        <button type="submit" class="btn btn-primary submit">
                            {{__('tobas.admin.create.submit')}}
                        </button>
                    </form>
