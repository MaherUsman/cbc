...
@section('content')
    ...
    @include('layouts.admin.includes.breadcrumbs' , ['breadcrumbs' => [['name' =>  __('animals.name') , 'route' => null]],
'pageTitle' => __('animals.reOrder')
])
                ...
                <div id="grid-view" class="tab-pane fade active show col-lg-12">
                    <div class="row" id="sortable">
                        @foreach($animals as $animal)
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12" id="{{$animal->id}}">
                                <div class="card card-img">
                                    <img src="{{asset($animal->image?:'no_image.jpg')}}" class="card-img-top img-fluid" alt="...">
                                    <div class="card-img-icon">
                                        <a title="Edit" href="{{route('animals.edit',$animal)}}">
                                        ...
                                        <a data-url="{{ route('animals.destroy', $animal) }}"
